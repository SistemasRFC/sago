                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-persian-dark text-uppercase">Usuários</h6>
                                    </div>

                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <button class='btn btn-primary btn-icon-split mb-3 new' data-toggle="modal" data-target="#usuarioModal">
