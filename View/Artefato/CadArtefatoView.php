...
<div class="modal fade" id="artefatoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Novo Artefato</h5>
            ...
            <form>
                ...
                <div class="form-group row">
                    <div class="col-sm-10 mb-3 mb-sm-0">
                        ...
                        <input type="text" id="dscArtefato" name="dscArtefato" class='persist input form-control'>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-6">
